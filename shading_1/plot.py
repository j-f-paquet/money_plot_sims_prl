...
#Map [0,1] to [0.5,1]
alpha=0.3
colors = mpl.cm.Greys(info_gain_zetas*(1-alpha)+alpha)

axes[0].plot(T_zetas, prior_5pct_zetas,"--",color='black',lw=2)
axes[0].plot(T_zetas, prior_95pct_zetas,"--",color='black',lw=2)

#axes[0].fill_between(T_zetas, prior_5pct_zetas,
#                prior_95pct_zetas,
#                color=mpl.cm.Greys(alpha), alpha=1.0, lw=2)
...
#Map [0,1] to [0.5,1]
alpha=0.3
colors = mpl.cm.Greys(info_gain_etas*(1-alpha)+alpha)

axes[1].plot(T_etas, prior_5pct_etas,"--",color='black',lw=2)
axes[1].plot(T_etas, prior_95pct_etas,"--",color='black',lw=2)
